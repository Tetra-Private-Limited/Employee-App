...
const navItems = [
  ...
  { href: '/tracking', label: 'Tracking', icon: MapPinIcon },
  { href: '/geofences', label: 'Geofences', icon: CircleIcon },
    ...
    <aside className="fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 flex flex-col z-30">
      ...
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-primary-600 text-white flex items-center justify-center text-sm font-bold">
            ET
          </div>
          <div>
            <h1 className="font-semibold text-gray-900 text-sm">Employee Tracker</h1>
